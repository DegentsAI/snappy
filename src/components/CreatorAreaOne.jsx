          ...
          <div className="row">
            <div className="col-lg-12 text-center">
              <h3
                ...
                data-aos-delay="400"
              >
                How <span style={{ color: "#DDF247" }}>Snappy</span> Works
              </h3>
            </div>
          </div>
        </div>
        <div className="row">
          ...
          >
            <div
              ...
              style={{ backgroundImage: 'url("assets/img/creator/bg.png")' }}
            >
              <div style={{ color: "#DDF247" }}>1. Drop a Prompt</div>
              <div style={{ color: "#fff", marginTop: "10px" }}>
                Tell Snappy what you're thinking. "A grumpy cat wearing
                sunglasses and a tiny hat." Yeah, we can do that.
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div
              ...
              style={{ backgroundImage: 'url("assets/img/creator/bg.png")' }}
            >
              <div style={{ color: "#DDF247" }}>2. Pick your style</div>
              <div style={{ color: "#fff", marginTop: "10px" }}>
                Choose the vibe that matches your sticker. Think 'anime,' 'chibi,' '3D,' etc.
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div
              ...
              style={{ backgroundImage: 'url("assets/img/creator/bg.png")' }}
            >
              <div style={{ color: "#DDF247" }}>3. Get Your Sticker Pack</div>
              <div style={{ color: "#fff", marginTop: "10px" }}>
                In a flash, we'll generate a fresh new sticker pack for you to download, share, and flex on your friends with.
              </div>
            </div>
          </div>
        </div>
