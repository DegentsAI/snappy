          ...
          <div className='col-lg-8'>
            ...
            >
                ...
                <div className='details p-0'>
                  ...
                  <blockquote className='text-center'>
                    <p>
                      ...
                      Victory Point designed by a top-notch gaming studio filled
                      ”
                    </p>
                  </blockquote>
                  <h4 className='title'>
              ...
              <div className='blog-comment'>
                <h4 className='mb-2'>Leave a Comments</h4>
              ...
              <form className='blog-comment-form'>
                ...
                <div className='row'>
                  ...
                  <div className='col-12'>
                    <input type='checkbox' /> Save my name, email, and website
